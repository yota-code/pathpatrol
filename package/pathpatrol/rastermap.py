...
class RasterMap() :
	...
	jump_index = { # clockwize : row, col relative to the matrix
		2: (-1, 0), 6: (-1, 0), 7: (-1, -1), 9: (0, -1), 11: (0, -1), 15: (0, -1), 22: (-1, 0), 23: (-1, -1), 27: (0, -1), 31: (0, -1), 41: (1, -1), 43: (1, -1), 47: (1, -1),
		63: (1, -1), 64: (1, 0), 86: (-1, 0), 104: (1, 0), 105: (1, 0), 107: (1, 0), 111: (1, 0), 150: (-1, 0), 151: (-1, -1),
		159: (0, -1), 191: (1, -1), 208: (0, 1), 212: (-1, 1), 214: (-1, 0), 215: (-1, -1), 232: (1, 1), 233: (1, 1),
		235: (1, 1), 240: (0, 1), 244: (-1, 1), 246: (-1, 0), 247: (-1, -1), 248: (0, 1), 249: (0, 1), 252: (-1, 1), 253: (-1, 1)
	}
